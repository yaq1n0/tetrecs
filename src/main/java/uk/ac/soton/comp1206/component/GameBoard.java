...
public class GameBoard extends GridPane {
    ...
    private boolean enableDrawHover = false;
    ...
    public void hover(GameBlock block) {
        if (isEnableDrawHover()) {
            block.setHoverBlock(true);
        }
    }

    public void unhover(GameBlock block) {
        if (isEnableDrawHover()) {
            block.setHoverBlock(false);
        }
    }
    ...
    public boolean isEnableDrawHover() {
        return enableDrawHover;
    }

    public void setEnableDrawHover(boolean enableDrawHover) {
        this.enableDrawHover = enableDrawHover;
    }
